...
- Detection is three-tier: `uv pip show pdomain-book-tools` editable probe → marker
...
- Cross-repo lockstep: the same pattern should land in `pdomain-book-tools` and
