...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ocr-cli/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ocr-cli/releases/tag/$VERSION"
