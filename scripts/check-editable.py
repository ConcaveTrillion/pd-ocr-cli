...
if len(sys.argv) != 2:
    print("usage: check-editable.py <expected-peer-path>", file=sys.stderr)  # noqa: T201  # CLI output
    sys.exit(2)
...
print("module_file=", module_file)  # noqa: T201  # CLI output
print("expected_peer=", expected_peer)  # noqa: T201  # CLI output
print("dist_version=", md.version("pd-book-tools"))  # noqa: T201  # CLI output
